/* Angular-Responsive-ImageSlider - v0.0.1 - 2018-01-03 */
!function() {
    "use strict";
    ...
    angular.module("image_slider").directive("imageSlider", [ "$timeout", function(e) {
        return {
            ...
            templateUrl: function(e, t) {
                ...
                switch (t.templateId) {
                  case "template1":
                    n = "view/template1.html";
                    break;

                  case "template2":
                    n = "view/template2.html";
                    break;

                  case "template3":
                    n = "view/template3.html";
                    break;
    ...
    angular.module("image_slider").controller("template1", [ "$scope", "utilities", function(e, t) {
        var n = this;
        n.enlargeImage = function(e) {
            n.enlargedImageIndex = e, $("#template1-modal").modal("open");
        }, n.closeModal = function() {
            $("#template1-modal").modal("close");
        };
        $(document).ready(function() {
            $(".slider").slider(n.options), $("#template1-modal").modal({
                dismissible: !0,
                opacity: .7,
                inDuration: 300,
                outDuration: 200,
